...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/r-filearray-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-filearray-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add r-filearray
# for installing globally
pixi global install r-filearray
```
...
It is possible to list all of the versions of `r-filearray` available on your platform:
...
```
pixi search r-filearray --channel conda-forge
```
